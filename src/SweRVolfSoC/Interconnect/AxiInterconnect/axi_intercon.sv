...
`ifdef RV_DC_ENABLE
    input  wire  [3:0] i_lsu_dc_awid,
    input  wire [31:0] i_lsu_dc_awaddr,
    input  wire  [7:0] i_lsu_dc_awlen,
    input  wire  [2:0] i_lsu_dc_awsize,
    input  wire  [1:0] i_lsu_dc_awburst,
    input  wire        i_lsu_dc_awlock,
    input  wire  [3:0] i_lsu_dc_awcache,
    input  wire  [2:0] i_lsu_dc_awprot,
    input  wire  [3:0] i_lsu_dc_awregion,
    input  wire  [3:0] i_lsu_dc_awqos,
    input  wire        i_lsu_dc_awvalid,
    output wire        o_lsu_dc_awready,
    input  wire  [3:0] i_lsu_dc_arid,
    input  wire [31:0] i_lsu_dc_araddr,
    input  wire  [7:0] i_lsu_dc_arlen,
    input  wire  [2:0] i_lsu_dc_arsize,
    input  wire  [1:0] i_lsu_dc_arburst,
    input  wire        i_lsu_dc_arlock,
    input  wire  [3:0] i_lsu_dc_arcache,
    input  wire  [2:0] i_lsu_dc_arprot,
    input  wire  [3:0] i_lsu_dc_arregion,
    input  wire  [3:0] i_lsu_dc_arqos,
    input  wire        i_lsu_dc_arvalid,
    output wire        o_lsu_dc_arready,
    input  wire [63:0] i_lsu_dc_wdata,
    input  wire  [7:0] i_lsu_dc_wstrb,
    input  wire        i_lsu_dc_wlast,
    input  wire        i_lsu_dc_wvalid,
    output wire        o_lsu_dc_wready,
    output wire  [3:0] o_lsu_dc_bid,
    output wire  [1:0] o_lsu_dc_bresp,
    output wire        o_lsu_dc_bvalid,
    input  wire        i_lsu_dc_bready,
    output wire  [3:0] o_lsu_dc_rid,
    output wire [63:0] o_lsu_dc_rdata,
    output wire  [1:0] o_lsu_dc_rresp,
    output wire        o_lsu_dc_rlast,
    output wire        o_lsu_dc_rvalid,
    input  wire        i_lsu_dc_rready,
`endif   
...
`ifdef RV_DC_ENABLE
   mst_req_t  [3:0] masters_req;
   mst_resp_t [3:0] masters_resp;
`else
...
`ifdef RV_DC_ENABLE
    //Master lsu_dc
   assign masters_req[3].aw.id = i_lsu_dc_awid;
   assign masters_req[3].aw.addr = i_lsu_dc_awaddr;
   assign masters_req[3].aw.len = i_lsu_dc_awlen;
   assign masters_req[3].aw.size = i_lsu_dc_awsize;
   assign masters_req[3].aw.burst = i_lsu_dc_awburst;
   assign masters_req[3].aw.lock = i_lsu_dc_awlock;
   assign masters_req[3].aw.cache = i_lsu_dc_awcache;
   assign masters_req[3].aw.prot = i_lsu_dc_awprot;
   assign masters_req[3].aw.region = i_lsu_dc_awregion;
   assign masters_req[3].aw.qos = i_lsu_dc_awqos;
   assign masters_req[3].aw.atop = 6'd0;
   assign masters_req[3].aw_valid = i_lsu_dc_awvalid;
   assign o_lsu_dc_awready = masters_resp[3].aw_ready;
   assign masters_req[3].ar.id = i_lsu_dc_arid;
   assign masters_req[3].ar.addr = i_lsu_dc_araddr;
   assign masters_req[3].ar.len = i_lsu_dc_arlen;
   assign masters_req[3].ar.size = i_lsu_dc_arsize;
   assign masters_req[3].ar.burst = i_lsu_dc_arburst;
   assign masters_req[3].ar.lock = i_lsu_dc_arlock;
   assign masters_req[3].ar.cache = i_lsu_dc_arcache;
   assign masters_req[3].ar.prot = i_lsu_dc_arprot;
   assign masters_req[3].ar.region = i_lsu_dc_arregion;
   assign masters_req[3].ar.qos = i_lsu_dc_arqos;
   assign masters_req[3].ar_valid = i_lsu_dc_arvalid;
   assign o_lsu_dc_arready = masters_resp[3].ar_ready;
   assign masters_req[3].w.data = i_lsu_dc_wdata;
   assign masters_req[3].w.strb = i_lsu_dc_wstrb;
   assign masters_req[3].w.last = i_lsu_dc_wlast;
   assign masters_req[3].w_valid = i_lsu_dc_wvalid;
   assign o_lsu_dc_wready = masters_resp[3].w_ready;
   assign o_lsu_dc_bid = masters_resp[3].b.id;
   assign o_lsu_dc_bresp = masters_resp[3].b.resp;
   assign o_lsu_dc_bvalid = masters_resp[3].b_valid;
   assign masters_req[3].b_ready = i_lsu_dc_bready;
   assign o_lsu_dc_rid = masters_resp[3].r.id;
   assign o_lsu_dc_rdata = masters_resp[3].r.data;
   assign o_lsu_dc_rresp = masters_resp[3].r.resp;
   assign o_lsu_dc_rlast = masters_resp[3].r.last;
   assign o_lsu_dc_rvalid = masters_resp[3].r_valid;
   assign masters_req[3].r_ready = i_lsu_dc_rready;
`endif  
